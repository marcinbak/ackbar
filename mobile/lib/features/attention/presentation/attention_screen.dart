    ...
    return GlassCard(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  color: session.agentColor.withValues(alpha: 0.15),
                  borderRadius: AppSpacing.roundedSm,
                  border: Border.all(color: session.agentColor.withValues(alpha: 0.4), width: 0.8),
                ),
                child: Row(
                  mainAxisSize: MainAxisSize.min,
                  children: [
          ...
          // Scrollable Middle Body (Question, Options, Context)
          Expanded(
                  ...
                  if (options.isNotEmpty) ...[
                    ...
                    ...List.generate(options.length, (optIdx) {
                      ...
                      return Padding(
                        ...
                        child: Material(
                          color: isSelected
                              ? AppColors.statusEmerald.withValues(alpha: 0.12)
          ...
          // Fixed Action Controls Pinned at Bottom
          TextField(
          ...
          SizedBox(
            ...
            child: ElevatedButton.icon(
              ...
              label: const Text('Submit Choice', style: TextStyle(fontWeight: FontWeight.w700)),
          ...
          // Secondary Tool Buttons Row (Terminal + Transcript)
          Row(
            children: [
              Expanded(
                child: OutlinedButton.icon(
                  ...
                  label: const Text('Live Terminal'),
